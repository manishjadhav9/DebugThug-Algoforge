...
import { fetchAgreementsFromBlockchain } from "@/lib/blockchain/blockchain-client"
  ...
  useEffect(() => {
    const fetchAgreements = async () => {
      try {
        ...
        // Show loading toast
        toast.info("Fetching Agreements", {
          description: "Retrieving your agreements from the blockchain...",
        });
        ...
        // Show success toast if agreements were found
        if (fetchedAgreements.length > 0) {
          toast.success("Agreements Loaded", {
            description: `Successfully loaded ${fetchedAgreements.length} rental agreements from the blockchain.`
          });
        } else {
          toast.info("No Agreements Found", {
            description: "No rental agreements were found for your account on the blockchain."
          });
        }
      } catch (error) {
        ...
        toast.error("Error", {
          description: error instanceof Error 
            ...
            : "Failed to fetch agreements from blockchain"
        });
      } finally {
        setIsLoading(false);
      }
                  ...
                  <div className="flex flex-col md:flex-row justify-between gap-4">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground flex items-center">
                        <span className="inline-flex mr-1 w-2 h-2 bg-green-500 rounded-full"></span>
                        TX: {agreement.transactionHash.slice(0, 10)}...
                      </p>
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-2 text-xs text-muted-foreground">
                          Block #{agreement.blockNumber.toLocaleString()}
                        </span>
                      </div>
